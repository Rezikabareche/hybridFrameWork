...
//            }
    ...
    public static void main(String[] args)  {
        String path = "C:\\Users\\My Pc\\eclipse-workspace\\Final_exam_Selenium-main\\src\\test\\java\\tutorialsNinja\\RazikaMAnualTestCases.xlsx";
        ExcelReader excelReader = new ExcelReader(path);
        System.out.println(excelReader.getValueForGivenHeaderAndKey("Register","Test Case Title",""));
